...
import { Layout, SEO, Button, Header, PerkItem } from "../components/Components";
...
const Volunteer = () => {
    const perks = [
        {
            heading: "Access to the largest network of UX designers in the Philippines",
            ...
            <Header
              content={
                  <>
                      ...
                      <p className="text-white">UXPH is always looking for passionate and enthusiastic individuals who want to be a part of the growing Filipino design community! Whether you're a professional, student, or simply a design enthusiast, we're happy to have you join us!</p>
                      <br />
                      <p className="text-white margin-bottom-32">If you’d like to join our team and get involved in the community, please fill out our form and we’ll get back to you as soon as we can.</p>
