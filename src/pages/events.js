...
import { Layout, SEO, HostEventItem, EventItem, Header, Button } from "../components/Components";
...
const EventsPage = () => {
    const hostFeature = {
        ...
        description: "Have an event idea? You can host your own UXPH-sanctioned event!",
    };
                ...
                <Box component="div">
                    <Grid container spacing={4}>
                        ...
                        <Grid item md={9}>
                            ...
                            <p className="text-white font-size-16 margin-bottom-16" style={{ fontWeight: "light" }}>
                                {events[0].date} | {events[0].time} | {events[0].venue}
                            </p>
                            <p className="text-white margin-bottom-16">{events[0].description}</p>
